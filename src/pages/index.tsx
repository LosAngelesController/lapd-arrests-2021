...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    var mapparams: any = {
      ...
      style: "mapbox://styles/kennethmejia/clhpk8uso00bd01rf4m4j78yd", // style URL (THIS IS STREET VIEW)
      ...
      >
        <Head>
          ...
          <meta
            name="twitter:image"
            key="twitterimg"
            content="https://2021arrests.lacontroller.io/lapd-arrests-2021.png"
          ></meta>
          <meta name="description" content="LAPD Arrests 2021." />

          <meta
            property="og:url"
            content="https://2021arrests.lacontroller.io"
          />
          <meta property="og:type" content="website" />
